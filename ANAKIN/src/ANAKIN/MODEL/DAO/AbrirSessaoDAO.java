...
public class AbrirSessaoDAO {
	...
	public ArrayList<String> abrirControleSessao(int id) {
		...
		// select nome_sessao, inventario_sessao, anotacoes_sessao from controle_sessao
		// where id_sessao = 1;
		// String sql = "SELECT nome_sessao, inventario_sessao, anotacoes_sessao from
		// controle_sessao where nome_sessao = ? and id_usuario = 'beabna'";
